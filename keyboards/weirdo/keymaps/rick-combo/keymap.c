...
const struct Chord chord_52 PROGMEM = {H_THU2, DVORAK, &state_52, &counter_52, KC_SPC, SYM, key_layer_dance};
uint8_t state_53 = IDLE;
const struct Chord chord_53 PROGMEM = {H_MID1, DVORAK, &state_53, NULL, KC_A, KC_RSFT, key_mod_dance};
uint8_t state_54 = IDLE;
const struct Chord chord_54 PROGMEM = {H_MID2, DVORAK, &state_54, NULL, KC_O, KC_RCTL, key_mod_dance};
uint8_t state_55 = IDLE;
const struct Chord chord_55 PROGMEM = {H_MID3, DVORAK, &state_55, NULL, KC_E, KC_RALT, key_mod_dance};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_MID5, DVORAK, &state_56, NULL, KC_I, KC_RGUI, key_mod_dance};
uint8_t state_57 = IDLE;
const struct Chord chord_57 PROGMEM = {H_MID6, DVORAK, &state_57, NULL, KC_D, KC_RGUI, key_mod_dance};
uint8_t state_58 = IDLE;
const struct Chord chord_58 PROGMEM = {H_MID8, DVORAK, &state_58, NULL, KC_T, KC_RCTL, key_mod_dance};
uint8_t state_59 = IDLE;
const struct Chord chord_59 PROGMEM = {H_MID9, DVORAK, &state_59, NULL, KC_N, KC_RCTL, key_mod_dance};
uint8_t state_60 = IDLE;
const struct Chord chord_60 PROGMEM = {H_MID10, DVORAK, &state_60, NULL, KC_S, KC_RSFT, key_mod_dance};
uint8_t state_61 = IDLE;
const struct Chord chord_61 PROGMEM = {H_TOP1, SYM, &state_61, NULL, KC_EXLM, 0, single_dance};
uint8_t state_62 = IDLE;
const struct Chord chord_62 PROGMEM = {H_TOP2, SYM, &state_62, NULL, KC_AT, 0, single_dance};
uint8_t state_63 = IDLE;
const struct Chord chord_63 PROGMEM = {H_TOP3, SYM, &state_63, NULL, KC_UP, 0, single_dance};
uint8_t state_64 = IDLE;
const struct Chord chord_64 PROGMEM = {H_TOP4, SYM, &state_64, NULL, KC_LCBR, 0, single_dance};
uint8_t state_65 = IDLE;
const struct Chord chord_65 PROGMEM = {H_TOP5, SYM, &state_65, NULL, KC_RCBR, 0, single_dance};
uint8_t state_66 = IDLE;
const struct Chord chord_66 PROGMEM = {H_TOP6, SYM, &state_66, NULL, KC_BSLS, 0, single_dance};
uint8_t state_67 = IDLE;
const struct Chord chord_67 PROGMEM = {H_TOP7, SYM, &state_67, NULL, KC_7, 0, single_dance};
uint8_t state_68 = IDLE;
const struct Chord chord_68 PROGMEM = {H_TOP8, SYM, &state_68, NULL, KC_8, 0, single_dance};
uint8_t state_69 = IDLE;
const struct Chord chord_69 PROGMEM = {H_TOP9, SYM, &state_69, NULL, KC_9, 0, single_dance};
uint8_t state_70 = IDLE;
const struct Chord chord_70 PROGMEM = {H_TOP10, SYM, &state_70, NULL, KC_ASTR, 0, single_dance};
uint8_t state_71 = IDLE;
const struct Chord chord_71 PROGMEM = {H_MID1, SYM, &state_71, NULL, KC_HASH, 0, single_dance};
uint8_t state_72 = IDLE;
const struct Chord chord_72 PROGMEM = {H_MID2, SYM, &state_72, NULL, KC_LEFT, 0, single_dance};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_MID3, SYM, &state_73, NULL, KC_DOWN, 0, single_dance};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_MID4, SYM, &state_74, NULL, KC_RGHT, 0, single_dance};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_MID5, SYM, &state_75, NULL, KC_DLR, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_MID6, SYM, &state_76, NULL, KC_EQL, 0, single_dance};
uint8_t state_77 = IDLE;
const struct Chord chord_77 PROGMEM = {H_MID7, SYM, &state_77, NULL, KC_4, 0, single_dance};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_MID8, SYM, &state_78, NULL, KC_5, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_MID9, SYM, &state_79, NULL, KC_9, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_MID10, SYM, &state_80, NULL, KC_0, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_BOT1, SYM, &state_81, NULL, KC_LBRC, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_BOT2, SYM, &state_82, NULL, KC_RBRC, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_BOT3, SYM, &state_83, NULL, KC_LPRN, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_BOT4, SYM, &state_84, NULL, KC_RPRN, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_BOT5, SYM, &state_85, NULL, KC_AMPR, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_BOT6, SYM, &state_86, NULL, KC_GRV, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_BOT7, SYM, &state_87, NULL, KC_1, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_BOT8, SYM, &state_88, NULL, KC_2, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_BOT9, SYM, &state_89, NULL, KC_3, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_BOT10, SYM, &state_90, NULL, KC_PLUS, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_TOP1, FNC, &state_91, NULL, KC_ESC, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_TOP2, FNC, &state_92, NULL, KC_QUES, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_TOP3, FNC, &state_93, NULL, KC_UNDS, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_TOP4, FNC, &state_94, NULL, KC_F1, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_TOP5, FNC, &state_95, NULL, KC_F2, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_TOP6, FNC, &state_96, NULL, KC_F3, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_TOP7, FNC, &state_97, NULL, KC_F4, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_TOP8, FNC, &state_98, NULL, KC_MINS, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_TOP9, FNC, &state_99, NULL, KC_SLSH, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_TOP10, FNC, &state_100, NULL, KC_BSPC, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_MID1, FNC, &state_101, NULL, KC_LSFT, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_MID2, FNC, &state_102, NULL, KC_TAB, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_MID3, FNC, &state_103, NULL, KC_PGUP, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_MID4, FNC, &state_104, NULL, KC_F5, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_MID5, FNC, &state_105, NULL, KC_F6, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_MID6, FNC, &state_106, NULL, KC_F7, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_MID7, FNC, &state_107, NULL, KC_F8, 0, single_dance};
uint8_t state_108 = IDLE;
const struct Chord chord_108 PROGMEM = {H_MID8, FNC, &state_108, NULL, KC_HOME, 0, single_dance};
uint8_t state_109 = IDLE;
const struct Chord chord_109 PROGMEM = {H_MID9, FNC, &state_109, NULL, KC_LALT, 0, single_dance};
uint8_t state_110 = IDLE;
const struct Chord chord_110 PROGMEM = {H_MID10, FNC, &state_110, NULL, KC_ENT, 0, single_dance};
uint8_t state_111 = IDLE;
const struct Chord chord_111 PROGMEM = {H_BOT1, FNC, &state_111, NULL, KC_CLCK, 0, single_dance};
uint8_t state_112 = IDLE;
const struct Chord chord_112 PROGMEM = {H_BOT2, FNC, &state_112, NULL, KC_SLCK, 0, single_dance};
uint8_t state_113 = IDLE;
const struct Chord chord_113 PROGMEM = {H_BOT3, FNC, &state_113, NULL, KC_PGDN, 0, single_dance};
uint8_t state_114 = IDLE;
const struct Chord chord_114 PROGMEM = {H_BOT4, FNC, &state_114, NULL, KC_F9, 0, single_dance};
uint8_t state_115 = IDLE;
const struct Chord chord_115 PROGMEM = {H_BOT5, FNC, &state_115, NULL, KC_F10, 0, single_dance};
uint8_t state_116 = IDLE;
const struct Chord chord_116 PROGMEM = {H_BOT6, FNC, &state_116, NULL, KC_F11, 0, single_dance};
uint8_t state_117 = IDLE;
const struct Chord chord_117 PROGMEM = {H_BOT7, FNC, &state_117, NULL, KC_F12, 0, single_dance};
uint8_t state_118 = IDLE;
const struct Chord chord_118 PROGMEM = {H_BOT8, FNC, &state_118, NULL, KC_END, 0, single_dance};
uint8_t state_119 = IDLE;
const struct Chord chord_119 PROGMEM = {H_BOT9, FNC, &state_119, NULL, KC_INS, 0, single_dance};
uint8_t state_120 = IDLE;
const struct Chord chord_120 PROGMEM = {H_BOT10, FNC, &state_120, NULL, KC_BSLS, 0, single_dance};
