...
const struct Chord chord_20 PROGMEM = {H_MID1, DVORAK, &state_20, NULL, KC_A, 0, single_dance};
uint8_t state_21 = IDLE;
const struct Chord chord_21 PROGMEM = {H_MID2, DVORAK, &state_21, NULL, KC_O, 0, single_dance};
uint8_t state_22 = IDLE;
const struct Chord chord_22 PROGMEM = {H_MID3, DVORAK, &state_22, NULL, KC_E, 0, single_dance};
...
const struct Chord chord_24 PROGMEM = {H_MID5, DVORAK, &state_24, NULL, KC_I, 0, single_dance};
uint8_t state_25 = IDLE;
const struct Chord chord_25 PROGMEM = {H_MID6, DVORAK, &state_25, NULL, KC_D, 0, single_dance};
...
const struct Chord chord_27 PROGMEM = {H_MID8, DVORAK, &state_27, NULL, KC_T, 0, single_dance};
uint8_t state_28 = IDLE;
const struct Chord chord_28 PROGMEM = {H_MID9, DVORAK, &state_28, NULL, KC_N, 0, single_dance};
uint8_t state_29 = IDLE;
const struct Chord chord_29 PROGMEM = {H_MID10, DVORAK, &state_29, NULL, KC_S, 0, single_dance};
...
const struct Chord chord_38 PROGMEM = {H_MID10 + H_BOT10, DVORAK, &state_38, NULL, KC_QUOTE, 0, single_dance};
...
const struct Chord chord_48 PROGMEM = {H_TOP1 + H_TOP2, DVORAK, &state_48, NULL, KC_TAB, 0, single_dance};
uint8_t state_49 = IDLE;
const struct Chord chord_49 PROGMEM = {H_TOP2 + H_TOP3, DVORAK, &state_49, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_50 = IDLE;
const struct Chord chord_50 PROGMEM = {H_TOP3 + H_TOP4, DVORAK, &state_50, NULL, KC_UNDERSCORE, 0, single_dance};
uint8_t state_51 = IDLE;
const struct Chord chord_51 PROGMEM = {H_TOP4 + H_TOP5, DVORAK, &state_51, NULL, KC_PIPE, 0, single_dance};
uint8_t state_52 = IDLE;
const struct Chord chord_52 PROGMEM = {H_TOP5 + H_TOP6, DVORAK, &state_52, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_53 = IDLE;
const struct Chord chord_53 PROGMEM = {H_TOP7 + H_TOP8, DVORAK, &state_53, NULL, KC_MINUS, 0, single_dance};
uint8_t state_54 = IDLE;
const struct Chord chord_54 PROGMEM = {H_TOP8 + H_TOP9, DVORAK, &state_54, NULL, KC_SLASH, 0, single_dance};
uint8_t state_55 = IDLE;
const struct Chord chord_55 PROGMEM = {H_BOT1 + H_BOT2, DVORAK, &state_55, NULL, KC_ENT, 0, single_dance};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_BOT4 + H_BOT5, DVORAK, &state_56, NULL, KC_TILDE, 0, single_dance};
uint8_t state_57 = IDLE;
const struct Chord chord_57 PROGMEM = {H_BOT5 + H_BOT6, DVORAK, &state_57, NULL, KC_GRAVE, 0, single_dance};
uint8_t state_58 = IDLE;
const struct Chord chord_58 PROGMEM = {H_BOT8 + H_BOT9, DVORAK, &state_58, NULL, KC_APP, 0, single_dance};
uint8_t state_59 = IDLE;
uint8_t counter_59 = 0;
const struct Chord chord_59 PROGMEM = {H_THU1, DVORAK, &state_59, &counter_59, KC_BSPC, FNC, key_layer_dance};
uint8_t state_60 = IDLE;
uint8_t counter_60 = 0;
const struct Chord chord_60 PROGMEM = {H_THU2, DVORAK, &state_60, &counter_60, KC_SPC, SYM, key_layer_dance};
uint8_t state_61 = IDLE;
uint8_t counter_61 = 0;
const struct Chord chord_61 PROGMEM = {H_THU1 + H_THU2, DVORAK, &state_61, &counter_61, KC_ENT, ADJ, key_layer_dance};
uint8_t state_62 = IDLE;
const struct Chord chord_62 PROGMEM = {H_MID1 + H_MID2, DVORAK, &state_62, NULL, KC_A, KC_LSFT, key_mod_dance};
uint8_t state_63 = IDLE;
const struct Chord chord_63 PROGMEM = {H_MID2 + H_MID3, DVORAK, &state_63, NULL, KC_O, KC_LCTL, key_mod_dance};
uint8_t state_64 = IDLE;
const struct Chord chord_64 PROGMEM = {H_MID3 + H_MID4, DVORAK, &state_64, NULL, KC_E, KC_LALT, key_mod_dance};
uint8_t state_65 = IDLE;
const struct Chord chord_65 PROGMEM = {H_MID5, DVORAK, &state_65, NULL, KC_I, KC_LGUI, key_mod_dance};
uint8_t state_66 = IDLE;
const struct Chord chord_66 PROGMEM = {H_MID6, DVORAK, &state_66, NULL, KC_D, KC_RGUI, key_mod_dance};
uint8_t state_67 = IDLE;
const struct Chord chord_67 PROGMEM = {H_MID7 + H_MID8, DVORAK, &state_67, NULL, KC_T, KC_RCTL, key_mod_dance};
uint8_t state_68 = IDLE;
const struct Chord chord_68 PROGMEM = {H_MID8 + H_MID9, DVORAK, &state_68, NULL, KC_N, KC_RCTL, key_mod_dance};
uint8_t state_69 = IDLE;
const struct Chord chord_69 PROGMEM = {H_MID9 + H_MID10, DVORAK, &state_69, NULL, KC_S, KC_RSFT, key_mod_dance};
...
const struct Chord chord_70 PROGMEM = {H_MID8 + H_MID9 + H_MID10, DVORAK, &state_70, &counter_70, 0, 0, function_70};
...
const struct Chord chord_71 PROGMEM = {H_MID7 + H_MID8 + H_MID9 + H_MID10, DVORAK, &state_71, &counter_71, 0, 0, function_71};
...
const struct Chord chord_72 PROGMEM = {H_MID1 + H_MID2 + H_MID3, DVORAK, &state_72, &counter_72, 0, 0, function_72};
...
const struct Chord chord_73 PROGMEM = {H_MID1 + H_MID2 + H_MID3 + H_MID4, DVORAK, &state_73, &counter_73, 0, 0, function_73};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_TOP1, SYM, &state_74, NULL, KC_EXLM, 0, single_dance};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_TOP2, SYM, &state_75, NULL, KC_AT, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_TOP3, SYM, &state_76, NULL, KC_UP, 0, single_dance};
uint8_t state_77 = IDLE;
const struct Chord chord_77 PROGMEM = {H_TOP4, SYM, &state_77, NULL, KC_LCBR, 0, single_dance};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_TOP5, SYM, &state_78, NULL, KC_RCBR, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_TOP6, SYM, &state_79, NULL, KC_BSLS, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_TOP7, SYM, &state_80, NULL, KC_7, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_TOP8, SYM, &state_81, NULL, KC_8, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_TOP9, SYM, &state_82, NULL, KC_9, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_TOP10, SYM, &state_83, NULL, KC_ASTR, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_MID1, SYM, &state_84, NULL, KC_HASH, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_MID2, SYM, &state_85, NULL, KC_LEFT, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_MID3, SYM, &state_86, NULL, KC_DOWN, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_MID4, SYM, &state_87, NULL, KC_RGHT, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_MID5, SYM, &state_88, NULL, KC_DLR, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_MID6, SYM, &state_89, NULL, KC_EQL, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_MID7, SYM, &state_90, NULL, KC_4, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_MID8, SYM, &state_91, NULL, KC_5, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_MID9, SYM, &state_92, NULL, KC_9, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_MID10, SYM, &state_93, NULL, KC_0, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_BOT1, SYM, &state_94, NULL, KC_LBRC, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_BOT2, SYM, &state_95, NULL, KC_RBRC, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_BOT3, SYM, &state_96, NULL, KC_LPRN, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_BOT4, SYM, &state_97, NULL, KC_RPRN, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_BOT5, SYM, &state_98, NULL, KC_AMPR, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_BOT6, SYM, &state_99, NULL, KC_GRV, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_BOT7, SYM, &state_100, NULL, KC_1, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_BOT8, SYM, &state_101, NULL, KC_2, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_BOT9, SYM, &state_102, NULL, KC_3, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_BOT10, SYM, &state_103, NULL, KC_PLUS, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_TOP1, FNC, &state_104, NULL, KC_ESC, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_TOP2, FNC, &state_105, NULL, KC_QUES, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_TOP3, FNC, &state_106, NULL, KC_UNDS, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_TOP4, FNC, &state_107, NULL, KC_F1, 0, single_dance};
uint8_t state_108 = IDLE;
const struct Chord chord_108 PROGMEM = {H_TOP5, FNC, &state_108, NULL, KC_F2, 0, single_dance};
uint8_t state_109 = IDLE;
const struct Chord chord_109 PROGMEM = {H_TOP6, FNC, &state_109, NULL, KC_F3, 0, single_dance};
uint8_t state_110 = IDLE;
const struct Chord chord_110 PROGMEM = {H_TOP7, FNC, &state_110, NULL, KC_F4, 0, single_dance};
uint8_t state_111 = IDLE;
const struct Chord chord_111 PROGMEM = {H_TOP8, FNC, &state_111, NULL, KC_MINS, 0, single_dance};
uint8_t state_112 = IDLE;
const struct Chord chord_112 PROGMEM = {H_TOP9, FNC, &state_112, NULL, KC_SLSH, 0, single_dance};
uint8_t state_113 = IDLE;
const struct Chord chord_113 PROGMEM = {H_TOP10, FNC, &state_113, NULL, KC_BSPC, 0, single_dance};
uint8_t state_114 = IDLE;
const struct Chord chord_114 PROGMEM = {H_MID1, FNC, &state_114, NULL, KC_LSFT, 0, single_dance};
uint8_t state_115 = IDLE;
const struct Chord chord_115 PROGMEM = {H_MID2, FNC, &state_115, NULL, KC_TAB, 0, single_dance};
uint8_t state_116 = IDLE;
const struct Chord chord_116 PROGMEM = {H_MID3, FNC, &state_116, NULL, KC_PGUP, 0, single_dance};
uint8_t state_117 = IDLE;
const struct Chord chord_117 PROGMEM = {H_MID4, FNC, &state_117, NULL, KC_F5, 0, single_dance};
uint8_t state_118 = IDLE;
const struct Chord chord_118 PROGMEM = {H_MID5, FNC, &state_118, NULL, KC_F6, 0, single_dance};
uint8_t state_119 = IDLE;
const struct Chord chord_119 PROGMEM = {H_MID6, FNC, &state_119, NULL, KC_F7, 0, single_dance};
uint8_t state_120 = IDLE;
const struct Chord chord_120 PROGMEM = {H_MID7, FNC, &state_120, NULL, KC_F8, 0, single_dance};
uint8_t state_121 = IDLE;
const struct Chord chord_121 PROGMEM = {H_MID8, FNC, &state_121, NULL, KC_HOME, 0, single_dance};
uint8_t state_122 = IDLE;
const struct Chord chord_122 PROGMEM = {H_MID9, FNC, &state_122, NULL, KC_LALT, 0, single_dance};
uint8_t state_123 = IDLE;
const struct Chord chord_123 PROGMEM = {H_MID10, FNC, &state_123, NULL, KC_ENT, 0, single_dance};
uint8_t state_124 = IDLE;
const struct Chord chord_124 PROGMEM = {H_BOT1, FNC, &state_124, NULL, KC_CLCK, 0, single_dance};
uint8_t state_125 = IDLE;
const struct Chord chord_125 PROGMEM = {H_BOT2, FNC, &state_125, NULL, KC_SLCK, 0, single_dance};
uint8_t state_126 = IDLE;
const struct Chord chord_126 PROGMEM = {H_BOT3, FNC, &state_126, NULL, KC_PGDN, 0, single_dance};
uint8_t state_127 = IDLE;
const struct Chord chord_127 PROGMEM = {H_BOT4, FNC, &state_127, NULL, KC_F9, 0, single_dance};
uint8_t state_128 = IDLE;
const struct Chord chord_128 PROGMEM = {H_BOT5, FNC, &state_128, NULL, KC_F10, 0, single_dance};
uint8_t state_129 = IDLE;
const struct Chord chord_129 PROGMEM = {H_BOT6, FNC, &state_129, NULL, KC_F11, 0, single_dance};
uint8_t state_130 = IDLE;
const struct Chord chord_130 PROGMEM = {H_BOT7, FNC, &state_130, NULL, KC_F12, 0, single_dance};
uint8_t state_131 = IDLE;
const struct Chord chord_131 PROGMEM = {H_BOT8, FNC, &state_131, NULL, KC_END, 0, single_dance};
uint8_t state_132 = IDLE;
const struct Chord chord_132 PROGMEM = {H_BOT9, FNC, &state_132, NULL, KC_INS, 0, single_dance};
uint8_t state_133 = IDLE;
const struct Chord chord_133 PROGMEM = {H_BOT10, FNC, &state_133, NULL, KC_BSLS, 0, single_dance};
uint8_t state_134 = IDLE;
const struct Chord chord_134 PROGMEM = {H_TOP1, ADJ, &state_134, NULL, KC_ESC, 0, single_dance};
uint8_t state_135 = IDLE;
const struct Chord chord_135 PROGMEM = {H_TOP2, ADJ, &state_135, NULL, KC_QUES, 0, single_dance};
uint8_t state_136 = IDLE;
const struct Chord chord_136 PROGMEM = {H_TOP3, ADJ, &state_136, NULL, KC_UNDS, 0, single_dance};
uint8_t state_137 = IDLE;
const struct Chord chord_137 PROGMEM = {H_TOP4, ADJ, &state_137, NULL, KC_F1, 0, single_dance};
uint8_t state_138 = IDLE;
const struct Chord chord_138 PROGMEM = {H_TOP5, ADJ, &state_138, NULL, KC_F2, 0, single_dance};
uint8_t state_139 = IDLE;
const struct Chord chord_139 PROGMEM = {H_TOP6, ADJ, &state_139, NULL, KC_F3, 0, single_dance};
uint8_t state_140 = IDLE;
const struct Chord chord_140 PROGMEM = {H_TOP7, ADJ, &state_140, NULL, KC_F4, 0, single_dance};
uint8_t state_141 = IDLE;
const struct Chord chord_141 PROGMEM = {H_TOP8, ADJ, &state_141, NULL, KC_MINS, 0, single_dance};
uint8_t state_142 = IDLE;
const struct Chord chord_142 PROGMEM = {H_TOP9, ADJ, &state_142, NULL, KC_SLSH, 0, single_dance};
uint8_t state_143 = IDLE;
const struct Chord chord_143 PROGMEM = {H_TOP10, ADJ, &state_143, NULL, KC_BSPC, 0, single_dance};
uint8_t state_144 = IDLE;
const struct Chord chord_144 PROGMEM = {H_MID1, ADJ, &state_144, NULL, KC_LSFT, 0, single_dance};
uint8_t state_145 = IDLE;
const struct Chord chord_145 PROGMEM = {H_MID2, ADJ, &state_145, NULL, KC_TAB, 0, single_dance};
uint8_t state_146 = IDLE;
const struct Chord chord_146 PROGMEM = {H_MID3, ADJ, &state_146, NULL, KC_PGUP, 0, single_dance};
uint8_t state_147 = IDLE;
const struct Chord chord_147 PROGMEM = {H_MID4, ADJ, &state_147, NULL, KC_F5, 0, single_dance};
uint8_t state_148 = IDLE;
const struct Chord chord_148 PROGMEM = {H_MID5, ADJ, &state_148, NULL, KC_F6, 0, single_dance};
uint8_t state_149 = IDLE;
const struct Chord chord_149 PROGMEM = {H_MID6, ADJ, &state_149, NULL, KC_F7, 0, single_dance};
uint8_t state_150 = IDLE;
const struct Chord chord_150 PROGMEM = {H_MID7, ADJ, &state_150, NULL, KC_F8, 0, single_dance};
uint8_t state_151 = IDLE;
const struct Chord chord_151 PROGMEM = {H_MID8, ADJ, &state_151, NULL, KC_HOME, 0, single_dance};
uint8_t state_152 = IDLE;
const struct Chord chord_152 PROGMEM = {H_MID9, ADJ, &state_152, NULL, KC_LALT, 0, single_dance};
uint8_t state_153 = IDLE;
const struct Chord chord_153 PROGMEM = {H_MID10, ADJ, &state_153, NULL, KC_ENT, 0, single_dance};
uint8_t state_154 = IDLE;
const struct Chord chord_154 PROGMEM = {H_BOT1, ADJ, &state_154, NULL, KC_CLCK, 0, single_dance};
uint8_t state_155 = IDLE;
const struct Chord chord_155 PROGMEM = {H_BOT2, ADJ, &state_155, NULL, KC_SLCK, 0, single_dance};
uint8_t state_156 = IDLE;
const struct Chord chord_156 PROGMEM = {H_BOT3, ADJ, &state_156, NULL, KC_PGDN, 0, single_dance};
uint8_t state_157 = IDLE;
const struct Chord chord_157 PROGMEM = {H_BOT4, ADJ, &state_157, NULL, KC_F9, 0, single_dance};
uint8_t state_158 = IDLE;
const struct Chord chord_158 PROGMEM = {H_BOT5, ADJ, &state_158, NULL, 0, 0, reset};
uint8_t state_159 = IDLE;
const struct Chord chord_159 PROGMEM = {H_BOT6, ADJ, &state_159, NULL, KC_F11, 0, single_dance};
uint8_t state_160 = IDLE;
const struct Chord chord_160 PROGMEM = {H_BOT7, ADJ, &state_160, NULL, KC_F12, 0, single_dance};
uint8_t state_161 = IDLE;
const struct Chord chord_161 PROGMEM = {H_BOT8, ADJ, &state_161, NULL, KC_END, 0, single_dance};
uint8_t state_162 = IDLE;
const struct Chord chord_162 PROGMEM = {H_BOT9, ADJ, &state_162, NULL, KC_INS, 0, single_dance};
uint8_t state_163 = IDLE;
const struct Chord chord_163 PROGMEM = {H_BOT10, ADJ, &state_163, NULL, KC_BSLS, 0, single_dance};

const struct Chord* const list_of_chords[] PROGMEM = {
    &chord_0, &chord_1, &chord_2, &chord_3, &chord_4, &chord_5, &chord_6, &chord_7, &chord_8, &chord_9, &chord_10, &chord_11, &chord_12, &chord_13, &chord_14, &chord_15, &chord_16, &chord_17, &chord_18, &chord_19, &chord_20, &chord_21, &chord_22, &chord_23, &chord_24, &chord_25, &chord_26, &chord_27, &chord_28, &chord_29, &chord_30, &chord_31, &chord_32, &chord_33, &chord_34, &chord_35, &chord_36, &chord_37, &chord_38, &chord_39, &chord_40, &chord_41, &chord_42, &chord_43, &chord_44, &chord_45, &chord_46, &chord_47, &chord_48, &chord_49, &chord_50, &chord_51, &chord_52, &chord_53, &chord_54, &chord_55, &chord_56, &chord_57, &chord_58, &chord_59, &chord_60, &chord_61, &chord_62, &chord_63, &chord_64, &chord_65, &chord_66, &chord_67, &chord_68, &chord_69, &chord_70, &chord_71, &chord_72, &chord_73, &chord_74, &chord_75, &chord_76, &chord_77, &chord_78, &chord_79, &chord_80, &chord_81, &chord_82, &chord_83, &chord_84, &chord_85, &chord_86, &chord_87, &chord_88, &chord_89, &chord_90, &chord_91, &chord_92, &chord_93, &chord_94, &chord_95, &chord_96, &chord_97, &chord_98, &chord_99, &chord_100, &chord_101, &chord_102, &chord_103, &chord_104, &chord_105, &chord_106, &chord_107, &chord_108, &chord_109, &chord_110, &chord_111, &chord_112, &chord_113, &chord_114, &chord_115, &chord_116, &chord_117, &chord_118, &chord_119, &chord_120, &chord_121, &chord_122, &chord_123, &chord_124, &chord_125, &chord_126, &chord_127, &chord_128, &chord_129, &chord_130, &chord_131, &chord_132, &chord_133, &chord_134, &chord_135, &chord_136, &chord_137, &chord_138, &chord_139, &chord_140, &chord_141, &chord_142, &chord_143, &chord_144, &chord_145, &chord_146, &chord_147, &chord_148, &chord_149, &chord_150, &chord_151, &chord_152, &chord_153, &chord_154, &chord_155, &chord_156, &chord_157, &chord_158, &chord_159, &chord_160, &chord_161, &chord_162, &chord_163
};

const uint16_t** const leader_triggers PROGMEM = NULL;
void (*leader_functions[]) (void) = {};

#define NUMBER_OF_CHORDS 164
