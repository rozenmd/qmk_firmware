...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DL] = LAYOUT( /* [> LOWER <] */
    KC_ESC,  _____, _____, _____, _____,                   _____, _____, _____, _____,   _____   ,
    KC_TAB,  _____, _____, _____, _____,                   _____, _____, _____, _____,   KC_ENT  ,
    KC_LSFT, _____, _____, _____, _____,                   _____, _____, _____, KC_MINS, KC_SLSH ,
  ...
  [_DR] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_DA), KC_INS,  KC_LGUI, KC_LSFT, KC_DELT, KC_TRNS, KC_LCTL, KC_SPC,  ALT_ENT, KC_0,   KC_DOT, KC_PGDN ),
  ...
  [_QW] = LAYOUT(
    ...
    KC_ESC, KC_TAB, KC_LGUI, SH_ENT,  ALBSPC, MO(_QR), KC_LCTL,  DR_SPC,  ALT_ESC, KC_MINS, KC_SLSH, KC_ENT ),

  [_QR] = LAYOUT(
    KC_EXLM, KC_AT,   KC_UP,   KC_LCBR, KC_RCBR,                   KC_BSLS, KC_7,    KC_8,   KC_9,   KC_ASTR ,
    KC_HASH, KC_LEFT, KC_DOWN, KC_RGHT, KC_DLR,                    KC_EQL,  KC_4,    KC_5,   KC_6,   KC_PLUS ,
    KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR,                   KC_GRV,  KC_1,    KC_2,   KC_3,   KC_PGUP ,
    TO(_QL), KC_INS,  KC_LGUI, KC_LSFT, KC_DELT, KC_TRNS, KC_LCTL, KC_SPC,  ALT_ENT, KC_0,   KC_DOT, KC_PGDN ),
