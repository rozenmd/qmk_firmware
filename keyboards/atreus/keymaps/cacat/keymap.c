...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DV] = LAYOUT(
    ...
    KC_ESC,  KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC, MO(_RS), KC_LCTL, KC_SPC,  KC_LALT, KC_MINS, KC_SLSH, KC_ENT
  ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), KC_INS,  KC_LGUI, KC_LSFT, KC_DELT, KC_TRNS, KC_LCTL, KC_SPC,  KC_LALT, KC_0,   KC_DOT, KC_PGDN ),
  /*
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    KC_NO,   KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, TO(_DV), KC_LCTL, KC_SPC,  KC_LALT, KC_PSCR, KC_SLCK, KC_PAUS ),

  [_QW] = LAYOUT(
    KC_Q,   KC_W,   KC_E,    KC_R,    KC_T,                      KC_Y,   KC_U,    KC_I,    KC_O,    KC_P    ,
    KC_A,   KC_S,   KC_D,    KC_F,    KC_G,                      KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN ,
    KC_Z,   KC_X,   KC_C,    KC_V,    KC_B,                      KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH ,
    KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC, MO(_QS), KC_LCTL, KC_SPC, KC_LALT, KC_MINS, KC_SLSH, KC_ENT ),

  [_QS] = LAYOUT(
    KC_EXLM, KC_AT,   KC_UP,   KC_LCBR, KC_RCBR,                   KC_BSLS, KC_7,    KC_8,   KC_9,   KC_ASTR ,
    KC_HASH, KC_LEFT, KC_DOWN, KC_RGHT, KC_DLR,                    KC_EQL,  KC_4,    KC_5,   KC_6,   KC_PLUS ,
    KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR,                   KC_GRV,  KC_1,    KC_2,   KC_3,   KC_PGUP ,
    TO(_DV), KC_INS,  KC_LGUI, KC_LSFT, KC_DELT, KC_TRNS, KC_LCTL, KC_SPC,  KC_LALT, KC_0,   KC_DOT, KC_PGDN ),
};
