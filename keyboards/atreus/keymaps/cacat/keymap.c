...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DV] = LAYOUT(
    ...
    KC_ESC,  KC_TAB,  KC_LGUI, SH_ESC,  KC_BSPC, MO(_RS), KC_LCTL, KC_SPC,  KC_LALT, KC_MINS, KC_SLSH, KC_ENT
  ),
  ...
  [_QW] = LAYOUT(
    ...
    KC_ESC, KC_TAB, KC_LGUI, SH_ESC,  KC_BSPC, MO(_QR), KC_LCTL, KC_SPC, KC_LALT, KC_MINS, KC_SLSH, KC_ENT ),
