...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT,  KC_QUOT,  KC_Q,     KC_J,   KC_K,  KC_X,      KC_B,   KC_M, KC_W,  KC_V, KC_Z, KC_MINS, \
                                KC_LGUI, LOWER,  KC_BSPC,   KC_SPC, RAISE,KC_RALT \
  ),

  [_LOWER] = LAYOUT( \
    KC_TRNS, KC_ESC,  KC_PSCR, KC_PAUS, KC_F1, KC_F2,     KC_F3,  KC_F4,  KC_INS,  KC_DELT, KC_BSPC, KC_TRNS,
    KC_TRNS, KC_CLCK, KC_TAB,  KC_PGUP, KC_F5, KC_F6,     KC_F7,  KC_F8,  KC_HOME, KC_LALT, KC_ENT , KC_TRNS,
    KC_TRNS, KC_LSFT, KC_SLCK, KC_PGDN, KC_F9, KC_F10,    KC_F11, KC_F12, KC_END,  KC_MINS, KC_SLSH, KC_TRNS,
                               KC_LGUI, LOWER, KC_BSPC,   KC_SPC, RAISE,KC_RALT \
  ),
