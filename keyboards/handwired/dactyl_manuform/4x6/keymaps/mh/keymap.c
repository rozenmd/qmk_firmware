...
[_LOWER] = LAYOUT(
    ...
    _______,_______,_______,_______,_______,RESET,              _______, KC_P1, KC_P2,  KC_P3,  KC_EQL, KC_UNDS,   \
...
[_RAISE] = LAYOUT(
    ...
    _______,_______,_______,_______,_______,RESET,              _______,_______,_______,_______,_______,KC_VOLD,   \
                    RESET,  _______,                                            _______,_______,                   \
                                            _______,_______,    _______,_______,                                   \
                                            _______,_______,    _______,_______,                                   \
                                            _______,_______,    _______,_______                                    \
