...
enum internal_keycodes {
    TOP1 = SAFE_RANGE,
    TOP2, TOP3, TOP4, TOP5, TOP6, TOP7, TOP8, TOP9, TOP10, MID1, MID2, MID3, MID4, MID5, MID6, MID7, MID8, MID9, MID10, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, BOT10, THU1, THU2, THU3, THU4,
    FIRST_INTERNAL_KEYCODE = TOP1,
    LAST_INTERNAL_KEYCODE = THU4
};

enum pseudolayers {
    DVORAK, SYM, FNC, ALWAYS_ON
};
...
#define NUMBER_OF_KEYS 34
#define DEFAULT_PSEUDOLAYER DVORAK

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(TOP1, TOP2, TOP3, TOP4, TOP5, TOP6, TOP7, TOP8, TOP9, TOP10, MID1, MID2, MID3, MID4, MID5, MID6, MID7, MID8, MID9, MID10, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, BOT10, THU1, THU2, THU3, THU4),
    [1] = LAYOUT(KC_SCLN, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_QUOT, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_BSPC, KC_ESC, KC_ENT, KC_SPC),
};
...
const struct Chord chord_21 PROGMEM = {H_MID2, DVORAK, &state_21, NULL, KC_I, 0, single_dance};
...
const struct Chord chord_30 PROGMEM = {H_BOT1, DVORAK, &state_30, NULL, KC_QUOTE, 0, single_dance};
uint8_t state_31 = IDLE;
const struct Chord chord_31 PROGMEM = {H_BOT2, DVORAK, &state_31, NULL, KC_Q, 0, single_dance};
uint8_t state_32 = IDLE;
const struct Chord chord_32 PROGMEM = {H_BOT3, DVORAK, &state_32, NULL, KC_J, 0, single_dance};
uint8_t state_33 = IDLE;
const struct Chord chord_33 PROGMEM = {H_BOT4, DVORAK, &state_33, NULL, KC_K, 0, single_dance};
uint8_t state_34 = IDLE;
const struct Chord chord_34 PROGMEM = {H_BOT5, DVORAK, &state_34, NULL, KC_X, 0, single_dance};
uint8_t state_35 = IDLE;
const struct Chord chord_35 PROGMEM = {H_BOT6, DVORAK, &state_35, NULL, KC_B, 0, single_dance};
uint8_t state_36 = IDLE;
const struct Chord chord_36 PROGMEM = {H_BOT7, DVORAK, &state_36, NULL, KC_M, 0, single_dance};
uint8_t state_37 = IDLE;
const struct Chord chord_37 PROGMEM = {H_BOT8, DVORAK, &state_37, NULL, KC_W, 0, single_dance};
uint8_t state_38 = IDLE;
const struct Chord chord_38 PROGMEM = {H_BOT9, DVORAK, &state_38, NULL, KC_V, 0, single_dance};
uint8_t state_39 = IDLE;
const struct Chord chord_39 PROGMEM = {H_BOT10, DVORAK, &state_39, NULL, KC_Z, 0, single_dance};
uint8_t state_40 = IDLE;
const struct Chord chord_40 PROGMEM = {H_TOP1 + H_TOP2, DVORAK, &state_40, NULL, KC_TAB, 0, single_dance};
uint8_t state_41 = IDLE;
const struct Chord chord_41 PROGMEM = {H_TOP2 + H_TOP3, DVORAK, &state_41, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_42 = IDLE;
const struct Chord chord_42 PROGMEM = {H_TOP3 + H_TOP4, DVORAK, &state_42, NULL, KC_UNDERSCORE, 0, single_dance};
uint8_t state_43 = IDLE;
const struct Chord chord_43 PROGMEM = {H_TOP4 + H_TOP5, DVORAK, &state_43, NULL, KC_PIPE, 0, single_dance};
uint8_t state_44 = IDLE;
const struct Chord chord_44 PROGMEM = {H_TOP5 + H_TOP6, DVORAK, &state_44, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_45 = IDLE;
const struct Chord chord_45 PROGMEM = {H_TOP7 + H_TOP8, DVORAK, &state_45, NULL, KC_MINUS, 0, single_dance};
uint8_t state_46 = IDLE;
const struct Chord chord_46 PROGMEM = {H_TOP8 + H_TOP9, DVORAK, &state_46, NULL, KC_SLASH, 0, single_dance};
uint8_t state_47 = IDLE;
const struct Chord chord_47 PROGMEM = {H_BOT1 + H_BOT2, DVORAK, &state_47, NULL, KC_ENT, 0, single_dance};
uint8_t state_48 = IDLE;
const struct Chord chord_48 PROGMEM = {H_BOT4 + H_BOT5, DVORAK, &state_48, NULL, KC_TILDE, 0, single_dance};
uint8_t state_49 = IDLE;
const struct Chord chord_49 PROGMEM = {H_BOT5 + H_BOT6, DVORAK, &state_49, NULL, KC_GRAVE, 0, single_dance};
uint8_t state_50 = IDLE;
const struct Chord chord_50 PROGMEM = {H_BOT8 + H_BOT9, DVORAK, &state_50, NULL, KC_APP, 0, single_dance};
uint8_t state_51 = IDLE;
uint8_t counter_51 = 0;
const struct Chord chord_51 PROGMEM = {H_THU1, DVORAK, &state_51, &counter_51, KC_BSPC, FNC, key_layer_dance};
uint8_t state_52 = IDLE;
const struct Chord chord_52 PROGMEM = {H_THU2, DVORAK, &state_52, NULL, KC_ESC, KC_RSFT, key_mod_dance};
uint8_t state_53 = IDLE;
const struct Chord chord_53 PROGMEM = {H_THU3, DVORAK, &state_53, NULL, KC_ENTER, KC_RALT, key_mod_dance};
uint8_t state_54 = IDLE;
uint8_t counter_54 = 0;
const struct Chord chord_54 PROGMEM = {H_THU4, DVORAK, &state_54, &counter_54, KC_SPC, SYM, key_layer_dance};
uint8_t state_55 = IDLE;
const struct Chord chord_55 PROGMEM = {H_MID1, DVORAK, &state_55, NULL, KC_A, KC_RSFT, key_mod_dance};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_MID2, DVORAK, &state_56, NULL, KC_O, KC_RCTL, key_mod_dance};
uint8_t state_57 = IDLE;
const struct Chord chord_57 PROGMEM = {H_MID3, DVORAK, &state_57, NULL, KC_E, KC_RALT, key_mod_dance};
uint8_t state_58 = IDLE;
const struct Chord chord_58 PROGMEM = {H_MID5, DVORAK, &state_58, NULL, KC_I, KC_RGUI, key_mod_dance};
uint8_t state_59 = IDLE;
const struct Chord chord_59 PROGMEM = {H_MID6, DVORAK, &state_59, NULL, KC_D, KC_RGUI, key_mod_dance};
uint8_t state_60 = IDLE;
const struct Chord chord_60 PROGMEM = {H_MID8, DVORAK, &state_60, NULL, KC_T, KC_RCTL, key_mod_dance};
uint8_t state_61 = IDLE;
const struct Chord chord_61 PROGMEM = {H_MID9, DVORAK, &state_61, NULL, KC_N, KC_RCTL, key_mod_dance};
uint8_t state_62 = IDLE;
const struct Chord chord_62 PROGMEM = {H_MID10, DVORAK, &state_62, NULL, KC_S, KC_RSFT, key_mod_dance};
uint8_t state_63 = IDLE;
const struct Chord chord_63 PROGMEM = {H_TOP1, SYM, &state_63, NULL, KC_EXLM, 0, single_dance};
uint8_t state_64 = IDLE;
const struct Chord chord_64 PROGMEM = {H_TOP2, SYM, &state_64, NULL, KC_AT, 0, single_dance};
uint8_t state_65 = IDLE;
const struct Chord chord_65 PROGMEM = {H_TOP3, SYM, &state_65, NULL, KC_UP, 0, single_dance};
uint8_t state_66 = IDLE;
const struct Chord chord_66 PROGMEM = {H_TOP4, SYM, &state_66, NULL, KC_LCBR, 0, single_dance};
uint8_t state_67 = IDLE;
const struct Chord chord_67 PROGMEM = {H_TOP5, SYM, &state_67, NULL, KC_RCBR, 0, single_dance};
uint8_t state_68 = IDLE;
const struct Chord chord_68 PROGMEM = {H_TOP6, SYM, &state_68, NULL, KC_BSLS, 0, single_dance};
uint8_t state_69 = IDLE;
const struct Chord chord_69 PROGMEM = {H_TOP7, SYM, &state_69, NULL, KC_7, 0, single_dance};
uint8_t state_70 = IDLE;
const struct Chord chord_70 PROGMEM = {H_TOP8, SYM, &state_70, NULL, KC_8, 0, single_dance};
uint8_t state_71 = IDLE;
const struct Chord chord_71 PROGMEM = {H_TOP9, SYM, &state_71, NULL, KC_9, 0, single_dance};
uint8_t state_72 = IDLE;
const struct Chord chord_72 PROGMEM = {H_TOP10, SYM, &state_72, NULL, KC_ASTR, 0, single_dance};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_MID1, SYM, &state_73, NULL, KC_HASH, 0, single_dance};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_MID2, SYM, &state_74, NULL, KC_LEFT, 0, single_dance};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_MID3, SYM, &state_75, NULL, KC_DOWN, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_MID4, SYM, &state_76, NULL, KC_RGHT, 0, single_dance};
uint8_t state_77 = IDLE;
const struct Chord chord_77 PROGMEM = {H_MID5, SYM, &state_77, NULL, KC_DLR, 0, single_dance};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_MID6, SYM, &state_78, NULL, KC_EQL, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_MID7, SYM, &state_79, NULL, KC_4, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_MID8, SYM, &state_80, NULL, KC_5, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_MID9, SYM, &state_81, NULL, KC_9, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_MID10, SYM, &state_82, NULL, KC_0, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_BOT1, SYM, &state_83, NULL, KC_LBRC, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_BOT2, SYM, &state_84, NULL, KC_RBRC, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_BOT3, SYM, &state_85, NULL, KC_LPRN, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_BOT4, SYM, &state_86, NULL, KC_RPRN, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_BOT5, SYM, &state_87, NULL, KC_AMPR, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_BOT6, SYM, &state_88, NULL, KC_GRV, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_BOT7, SYM, &state_89, NULL, KC_1, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_BOT8, SYM, &state_90, NULL, KC_2, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_BOT9, SYM, &state_91, NULL, KC_3, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_BOT10, SYM, &state_92, NULL, KC_PLUS, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_TOP1, FNC, &state_93, NULL, KC_ESC, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_TOP2, FNC, &state_94, NULL, KC_QUES, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_TOP3, FNC, &state_95, NULL, KC_UNDS, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_TOP4, FNC, &state_96, NULL, KC_F1, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_TOP5, FNC, &state_97, NULL, KC_F2, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_TOP6, FNC, &state_98, NULL, KC_F3, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_TOP7, FNC, &state_99, NULL, KC_F4, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_TOP8, FNC, &state_100, NULL, KC_MINS, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_TOP9, FNC, &state_101, NULL, KC_SLSH, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_TOP10, FNC, &state_102, NULL, KC_BSPC, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_MID1, FNC, &state_103, NULL, KC_LSFT, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_MID2, FNC, &state_104, NULL, KC_TAB, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_MID3, FNC, &state_105, NULL, KC_PGUP, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_MID4, FNC, &state_106, NULL, KC_F5, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_MID5, FNC, &state_107, NULL, KC_F6, 0, single_dance};
uint8_t state_108 = IDLE;
const struct Chord chord_108 PROGMEM = {H_MID6, FNC, &state_108, NULL, KC_F7, 0, single_dance};
uint8_t state_109 = IDLE;
const struct Chord chord_109 PROGMEM = {H_MID7, FNC, &state_109, NULL, KC_F8, 0, single_dance};
uint8_t state_110 = IDLE;
const struct Chord chord_110 PROGMEM = {H_MID8, FNC, &state_110, NULL, KC_HOME, 0, single_dance};
uint8_t state_111 = IDLE;
const struct Chord chord_111 PROGMEM = {H_MID9, FNC, &state_111, NULL, KC_LALT, 0, single_dance};
uint8_t state_112 = IDLE;
const struct Chord chord_112 PROGMEM = {H_MID10, FNC, &state_112, NULL, KC_ENT, 0, single_dance};
uint8_t state_113 = IDLE;
const struct Chord chord_113 PROGMEM = {H_BOT1, FNC, &state_113, NULL, KC_CLCK, 0, single_dance};
uint8_t state_114 = IDLE;
const struct Chord chord_114 PROGMEM = {H_BOT2, FNC, &state_114, NULL, KC_SLCK, 0, single_dance};
uint8_t state_115 = IDLE;
const struct Chord chord_115 PROGMEM = {H_BOT3, FNC, &state_115, NULL, KC_PGDN, 0, single_dance};
uint8_t state_116 = IDLE;
const struct Chord chord_116 PROGMEM = {H_BOT4, FNC, &state_116, NULL, KC_F9, 0, single_dance};
uint8_t state_117 = IDLE;
const struct Chord chord_117 PROGMEM = {H_BOT5, FNC, &state_117, NULL, KC_F10, 0, single_dance};
uint8_t state_118 = IDLE;
const struct Chord chord_118 PROGMEM = {H_BOT6, FNC, &state_118, NULL, KC_F11, 0, single_dance};
uint8_t state_119 = IDLE;
const struct Chord chord_119 PROGMEM = {H_BOT7, FNC, &state_119, NULL, KC_F12, 0, single_dance};
uint8_t state_120 = IDLE;
const struct Chord chord_120 PROGMEM = {H_BOT8, FNC, &state_120, NULL, KC_END, 0, single_dance};
uint8_t state_121 = IDLE;
const struct Chord chord_121 PROGMEM = {H_BOT9, FNC, &state_121, NULL, KC_INS, 0, single_dance};
uint8_t state_122 = IDLE;
const struct Chord chord_122 PROGMEM = {H_BOT10, FNC, &state_122, NULL, KC_BSLS, 0, single_dance};
